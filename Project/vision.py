...
# --- Image Import ---
def image_acquisition(image_index):
    all_images = [cv2.imread('img_'+str(i)+'.jpg') for i in range(0,50)]
...
#   plt.show()
    ...
    # Calculate Contours
    contours, _ = cv2.findContours(img_open, cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE) #RETR_EXTERNAL
...
def vision_main():
    ...
    appended_contours = contours_blue.copy()
...
#                print("No gripper collision", collision_flag_list)
                ...
                return x_center_offset, y_center_offset, angle_offset, color, img_obb
...
#       print("No collision free pick found")
        ...
        return 0, 0, 0, 0, black_frame # Failed